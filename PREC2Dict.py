...
#Hold the initial cwd to be restored after function completes.
...
#Call TK to get root source folder of carved item.
Tk().withdraw() 
...
for dirpath, dirnames, filenames in os.walk(carveoutparent):
    for filename in filenames:
        if filename.lower().endswith(tuple(EXT_LIST)):
            ...
            #Commented out print section to speed up process.
            '''
            ...
            print(filedict)
            #Creates sample output of dictionary objects to simple json.
